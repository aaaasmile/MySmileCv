class IdentpicturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @identpicture.save
        format.html { redirect_to @identpicture,  notice: t('Picture was successfully created.')}
      else
  ...
  def update
    respond_to do |format|
      if @identpicture.update_attributes(identpicture_params)
        format.html {redirect_to @identpicture, notice: t('Picture was successfully updated.')}
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to identpictures_url, notice: t('Picture was successfully destroyed.') }
    end
  end
